...
let productdata=[]
function Fetchdata() {
    fetch("https://aniket-backed-js.onrender.com/pitches").then((res) => res.json())
        .then((data) => {
            Cardlist(data)
            productdata=data
        })
...
//    console.log(product) 
fetch("https://aniket-backed-js.onrender.com/pitches",{
    method:"POST",
    headers :{
...
function deleteProduct(id) {
    fetch(`https://aniket-backed-js.onrender.com/pitches/${id}`, {
        method: "DELETE"
    })
    .then((res) => res.json())
    .then((data) => {
...
function populateform(id){
    fetch(`https://aniket-backed-js.onrender.com/pitches/${id}`).then((res)=>res.json())
    .then((data)=>{
        console.log(data)
...
updatePitchBtn.addEventListener("click",()=>{
    ...
    fetch(`https://aniket-backed-js.onrender.com/pitches/${updateproductdata.id}`,{
        method:"PUT",
        headers:{
            "Content-Type":"application/json"
        },
...
updatePricePitchPriceButton.addEventListener("click",()=>{
    ...
    fetch(`https://aniket-backed-js.onrender.com/pitches/${updateprice.id}`,{
        method:"PUT",
        headers:{
            "Content-Type":"application/json"
        },
